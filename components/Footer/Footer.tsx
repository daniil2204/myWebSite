...
const Footer = () => {
  return (
    <footer className="footer fixed bottom-0 w-full z-30 h-20 bg-[#121212] text-white flex justify-center">
      <div className="container w-full pt-6 px-12 flex justify-around">
